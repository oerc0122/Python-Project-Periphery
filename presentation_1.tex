...
\begin{frame}{From script to project}
    \begin{itemize}[<+->]
        ...
        \item{}We're going to make a new folder ``\foldt{polysolve}'' and \cmd{git mv}\footnote{\cmd{git mv} tells \cmd{git} to track the file as it moves}  ``\filet{solver.py}'' into it.
    \end{itemize}

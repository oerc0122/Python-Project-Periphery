...
\begin{frame}{Sensible names}
    \begin{alertblock}{Your turn}
        \begin{itemize}
            ...
            \item{}Rename \kw{florp2} to \kw{quartic}
        \end{itemize}
    \end{alertblock}
\end{frame}
...
\begin{frame}[fragile]{Adding to pyproject}
    \begin{alertblock}{Adding it in}
        \begin{itemize}
            ...
            \item{}\cmd{add} all appropriate files and get it on git.
        \end{itemize}
...
\begin{frame}{Documentation in Actions(s)}
    ...
    \only<2>{
        \begin{center}
            \includegraphics[width=0.9\textwidth]{Images/original-action.jpg}
        \end{center}
    }
    \only<3>{
        \begin{center}
            \includegraphics[width=0.9\textwidth]{Images/modified-action.jpg}
        \end{center}
    }
    \only<4>{
        \begin{center}
            \includegraphics[width=0.9\textwidth]{Images/manual-workflow.jpg}
        \end{center}
    }
\end{frame}
